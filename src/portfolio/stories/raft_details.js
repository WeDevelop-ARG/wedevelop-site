      ...
      <>
        ...
        <ul>
          ...
          <li>
            ...
            <p>
              We integrated with SMS and Email providers to send notifications and other relevant information to the customers (booking confirmations, changes on schedule, etc).
            </p>
          </li>
        </ul>
        <h4>Biz Portal</h4>
