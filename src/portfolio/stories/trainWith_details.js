...
const trainWithDetails = {
  ...
  challenge: {
    ...
    content: (
      <>
        <p>
          As the origin of the word “crisis”, TrainWith’s CEO Rachel Aram, saw an opportunity
          to adapt the platform to the current situation, enabling not only individual fitness
          trainers to share their content but also gyms and fitness franchises to do so.
        </p>
        <p>
          To add to the challenge of this core change itself, the platform was actively working
          with thousands of users, and signing up new users every day.
        </p>
        <p>
          Furthermore, the backend of the platform had a lot of legacy code (a common situation
          of startup products that iterated a lot), and the frontend of the platform was a native
          iOS app that was also not very scalable.
        </p>
      </>
    )
  },
  ...
  solution: {
    ...
    content: (
      <>
        <p>
          As always, we focus on achieving the business goals first. For goals to be achieved, it
          not only requires to do the thing that’s needed but also to do it on time.
        </p>
        <p>
        ...
        <p>
          We tried to reuse as much of the legacy code as possible, writing as many tests as the
          code allowed to avoid bugs.
        </p>
        <p>
        ...
        <p>
          ...
          Store was cumbersome and not as agile as we need. Also, the app’s code wasn’t that
          good either, so every change demanded a lot of time and the results didn’t meet our expectations.
        </p>
        <p>
          After we identified this and evaluated this situation thoroughly, we ran surveys
          and other customer research tools to find out what devices people were using. Not
          surprisingly, Android users weren’t happy about not having an option for Android.
          But we also found out that iOS users weren’t happy either with the app and its clunky UX.
        </p>
        <p>
          Finally, we developed a new web-based version of the platform, optimized for different
          device sizes (mobile phones, ipads, tablets, laptops, desktop computers, etc).
        </p>
      </>
    ),
