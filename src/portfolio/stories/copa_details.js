...
const copaDetails = {
  ...
  solution: {
    ...
    content: (
      <>
        <p>
          We worked alongside COPA's stakeholders, GM, the Accounting
          department, and all other areas to design and implement the software
          they need in the 3-month window time.
        </p>
        <p>
        ...
        <p>
          ...
          basic User Experience aspects for the digital solutions, then develop
          small pieces of software, deploy them, test them, and so on.
        </p>
        <p>
          After a few months of development, a Minimal Viable Product would be
          released and users would start to use it, giving feedback, and the
          team that created the product would use that feedback to improve it.
        </p>
        <p>
          In the case of COPA STC, they found out the need for this custom
          solution 3 months before opening the doors of their amazing facility.
        </p>
        <p>
          WeDevelop jumped right in -when no other software company dared to do
          so- and helped COPA to materialize their dream: seeing athletes
          training in their top-notch facility.
        </p>
        <p>
        ...
        <p>
          ...
          cross-functional team that pushed on a sophisticated development cycle
          that allowed us to deliver consistently every couple of weeks.
        </p>
        <p>
          The first versions, as you can imagine, were just the basic stuff COPA
          needed to operate their business. Release by release, their software
          grew and became a full facility management system with a lot of
        ...
        <ul>
          <li>
            ...
            <p>
              ...
              branded platform, optimized for the business needs, and able to
              iterate as the business model does.
            </p>
            <ul>
              <li>
                Classes Scheduling
                <p>
                  Ability to schedule classes of different practices during the
                  week. Manage a complex schedule with multiple instructors,
              ...
              <li>
                Billing
                <p>
                  Billing management, reporting, payments for memberships,
                  one-time class passes, reporting.
                </p>
              </li>
              <li>
              ...
              <li>
                ...
                <p>
                  Allow COPA to define its memberships according to the business
          ...
          <li>
            Facility Tools
            <p>
              Auxiliary solutions to support the big and sophisticated facility
              operations.
            </p>
            <ul>
              <li>
                ...
                <p>
                  “WeDevelop proposed a purely custom solution. They provided a
                  touchless verification check in, which is better. It really
                  streamlines our process and aligns with our facility and our
                  goals of being the most technologically advanced training
                  facility in the world open to the public.”
                </p>
              </li>
              <li>
                Wayfinding Maps
                <p>
                  Interactive wayfinding maps for the 110,000 square foot
                  facility.
                </p>
              </li>
              <li>
                Data Pipeline
                <p>
                  We created a solid structure for the data to travel from the
                  different training devices to a central database. This allowed
                  COPA to extract actionable metrics and stats for its athletes.
                </p>
              </li>
            </ul>
          </li>
          <li>
            Customers Portal
            <p>A branded portal for a complete customers’ self-service.</p>
            <ul>
              <li>
                Booking Classes
                <p>
                  Allow customers to book their classes, reschedule, or cancel
                  them.
                </p>
              </li>
              <li>
                ...
                <p>
                  Allow customers to navigate through COPA’s memberships and
                  other packages, and sign up to them.
                </p>
              </li>
            </ul>
          </li>
        ...
        <p>
          ...
          usability testing to ensure the UI and UX of all the interfaces we
          designed were easy-to-use tools that make people’s life easier.
        </p>
        <p>
          The results of these sessions provided not only insights for improving
          our digital tools but also provided highly valuable insights to COPA’s
          business, facility, crew, and more.
        </p>
      </>
    ),
