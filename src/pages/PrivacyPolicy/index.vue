<template>
  <div class="privacy-policy">
    <router-link to="/#app" class="wedevelop-icon" v-smooth-scroll="{ duration: 2000}">
      <img src="../../assets/img/wedevelop-icon.svg" alt="WeDevelop" />
    </router-link>

    <h1>Privacy Policy</h1>

    <p class="last-update">Last updated: March 17, 2020</p>
    ...
    <ul>
      ...
      <li>
        <p>
          <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Wedevelop LLC, 2320 Ponce de Leon Blvd., Coral Gables, FL 33134.
        </p>
      </li>
      <li>
      ...
      <li>
        <strong>Website</strong> refers to Wedevelop, accessible from www.wedevelop.me
      </li>
      <li>
    ...
    <ul>
      <li>
        By email:
        <span class="highlight">info@wedevelop.me</span>
      </li>
    </ul>
  </div>
</template>
