...
function GetFreeQuoteContent ({ onSubmitFinished }) {
  return (
    <>
      ...
      <div className={classes.wrapper}>
        ...
        <FreeQuote className={classes.formContainer} onSubmitFinished={onSubmitFinished} />
      </div>
    </>
  )
}

export default GetFreeQuoteContent
