...
export default function SidebarModal({ className }) {
  ...
  return (
    <aside className={containerClass}>
      ...
      <div className={classes.content}>
        ...
        <p className={classes.rightSideText}>You'll be connected to one of our Account Managers and we'll offer our help to make your life easier.</p>
